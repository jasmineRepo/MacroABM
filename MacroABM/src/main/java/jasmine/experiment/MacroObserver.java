...
public class MacroObserver extends AbstractSimulationObserverManager implements EventListener {
	...
	private boolean gdpAccountingIdentities = true;
...
//	private boolean expenditureComponentsToGDP = true;
	...
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean cFirmsCreditRationing = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean cFirmsDebt = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean cFirmsCapitalStock = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean cFirmsCostPriceMarkup = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean cFirmsInvestment = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean cFirmsInvestmentToGDP = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean consumptionGoodsMarket = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean productivity = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean firmsProfits = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean firmsProfitsToGDP = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	...
	@GUIparameter(description = "Toggle to turn chart on / off")
	private boolean firmAssets = true;
	@GUIparameter(description = "Toggle to turn chart on / off")
	...
	public void buildObjects() {
		...
		if(charts){
			...
			if(gdpAccountingIdentities) {	
				Set<JInternalFrame> newAccountingIdentitiesPlots = new LinkedHashSet<JInternalFrame>();
				
			    TimeSeriesSimulationPlotter gdpPlot = new TimeSeriesSimulationPlotter("GDP levels comparison", "Log"); 
				gdpPlot.addSeries("GDP (expenditure) = Consumption + Gross Investment", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogGdpEx));
				gdpPlot.addSeries("GDP (income) = Wages + Interest + Profits + Depreciation", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogGdpInc));
				gdpPlot.addSeries("GDP (Income without depreciation) = Wages + Interest + Profits", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogGdpIncWithoutDep));
				updateChartSet.add(gdpPlot);			//Add to set to be updated in buildSchedule method
				newAccountingIdentitiesPlots.add(gdpPlot); 							    			    			    
			    
				TimeSeriesSimulationPlotter gdpComparisonPlot = new TimeSeriesSimulationPlotter("GDP ratios", ""); 
				gdpComparisonPlot.addSeries("GDP: expenditure / income", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.GdpExToGdpInc));
				gdpComparisonPlot.addSeries("GDP: expenditure / income without deprecation", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.GdpExToGdpIncWithoutDep));
				updateChartSet.add(gdpComparisonPlot);			//Add to set to be updated in buildSchedule method
				newAccountingIdentitiesPlots.add(gdpComparisonPlot); 							    			    			    
				
				TimeSeriesSimulationPlotter gdpExpenditureComponentsPlot = new TimeSeriesSimulationPlotter("Components of GDP (expenditure)", "%"); 
				gdpExpenditureComponentsPlot.addSeries("Consumption / GDPex", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.ConsumptionToYcinPercent));
				gdpExpenditureComponentsPlot.addSeries("Gross Investment / GDPex", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.InvestmentToYcinPercent));
				updateChartSet.add(gdpExpenditureComponentsPlot);			//Add to set to be updated in buildSchedule method
				newAccountingIdentitiesPlots.add(gdpExpenditureComponentsPlot);
				
				TimeSeriesSimulationPlotter gdpIncomeComponentsPlot = new TimeSeriesSimulationPlotter("Components of GDP (income)", "%"); 
				gdpIncomeComponentsPlot.addSeries("Wages / GDPinc", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.WagesToGDPincPercent));
				gdpIncomeComponentsPlot.addSeries("Profits / GDPinc", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.ProfitsToGDPincPercent));
				gdpIncomeComponentsPlot.addSeries("Interest / GDPinc", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.InterestToGDPincPercent));
				gdpIncomeComponentsPlot.addSeries("Depreciation / GDPinc", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.DepreciationToGDPincPercent));
				updateChartSet.add(gdpIncomeComponentsPlot);			//Add to set to be updated in buildSchedule method
				newAccountingIdentitiesPlots.add(gdpIncomeComponentsPlot); 							    			 

				TimeSeriesSimulationPlotter gdpIncomeWithoutDepComponentsPlot = new TimeSeriesSimulationPlotter("Components of GDP (income without depreciation)", "%"); 
				gdpIncomeWithoutDepComponentsPlot.addSeries("Wages / GDPincWithoutDep", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.WagesToGDPincWithoutDepPercent));
				gdpIncomeWithoutDepComponentsPlot.addSeries("Profits / GDPincWithoutDep", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.ProfitsToGDPincWithoutDepPercent));
				gdpIncomeWithoutDepComponentsPlot.addSeries("Interest / GDPincWithoutDep", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.InterestToGDPincWithoutDepPercent));
				updateChartSet.add(gdpIncomeWithoutDepComponentsPlot);			//Add to set to be updated in buildSchedule method
				newAccountingIdentitiesPlots.add(gdpIncomeWithoutDepComponentsPlot); 							    			 

				tabSet.add(createScrollPaneFromPlots(newAccountingIdentitiesPlots, "GDP Components", newAccountingIdentitiesPlots.size()));
...
//				logOutputConsumptionInvestment.addSeries("Aggregate Demand", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogAggregateDemand));
	...
	//			GuiUtils.addWindow(logOutputConsumptionInvestment, 0, 0, 300, 250);
		    ...
		    if(!dosiComparison){
			    ...
			    if(creditActivity) {
					...
					bankMarket.addSeries("Credit Supply (Bank)", (IDoubleSource) new MultiTraceFunction.Double(bank, Bank.Variables.LogCreditSupply));
					bankMarket.addSeries("Credit Demand (cFirms)", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogCreditDemand));
	...
	//				GuiUtils.addWindow(bankMarket, 300, 0, 300, 250);
			    ...
			    if(cFirmsCreditRationing) {
					TimeSeriesSimulationPlotter creditRationing = new TimeSeriesSimulationPlotter("Credit Rationing of Consumption Good Firms", "%");
	...
	//			    Set<JInternalFrame> debtPlots = new LinkedHashSet<JInternalFrame>();
					TimeSeriesSimulationPlotter debt = new TimeSeriesSimulationPlotter("Debt (Consumption Good Firms)", "Log");
					debt.addSeries("Debt", (IDoubleSource) new MultiTraceFunction.Double(bank, Bank.Variables.LogDebt));
					debt.addSeries("Bad debt", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogBadDebt));
	//				debt.addSeries("Bank Bad debt (log)", (IDoubleSource) new MultiTraceFunction.Double(bank, Bank.Variables.LogBadDebt)); 
					debt.setName("cFirms: Debt");
...
//				tabSet.add(createScrollPaneFromPlots(debtPlots, "Debt", debtPlots.size()));		//Add to set of charts to feature in tabbed pane
			    ...
			    if(cFirmsCapitalStock) {
					TimeSeriesSimulationPlotter capital = new TimeSeriesSimulationPlotter("Capital Stock of Consumption Good Firms", "Log");
	//				capital.addSeries("", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.Empty));					//XXX: Ross: Not sure what Hugo was hoping to achieve here
					...
					capital.setName("cFirms: Capital Stock");
	...
	//				laborMarket.addSeries("", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.Empty));				//XXX: Ross: Not sure what Hugo was hoping to achieve here
					...
					costPriceMarkUp.setName("cFirms: Cost, Price & Mark-up");
...
////				GuiUtils.addWindow(capitalMarket, 0, 250, 300, 250);
	...
	//				expansionaryInvestmentPlot.setName("Investment");
				...
				tabSet.add(createScrollPaneFromPlots(investmentPlots, "cFirms: Investment", investmentPlots.size()));
		    }

			if(!dosiComparison) {
				
				if(cFirmsInvestmentToGDP) {
	...
	//				expansionaryInvestmentPlot.setName("Investment");
					...
					tabSet.add(createScrollPaneFromPlots(investmentToGDPPlots, "cFirms: Investment to GDP", investmentToGDPPlots.size()));
				}
				
			    if(consumptionGoodsMarket) {
					TimeSeriesSimulationPlotter goodMarket = new TimeSeriesSimulationPlotter("Consumption Goods Market", "Log");
					goodMarket.addSeries("Production (Consumption Good Firms)", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.LogProduction_cFirms));
	...
	//				rdAll.addSeries("Top Machine Productivity", (IDoubleSource) new MultiTraceFunction.Double(collector, MacroCollector.Variables.TopProdMachine));	//was labelled 'Top Prod Capital'.
			    ...
			    if(firmsProfits) {
				    ...
				    tabSet.add(createScrollPaneFromPlots(profitPlots, "Firms Profit", profitPlots.size()));					//Tab will be created for this chart
			    }

			    if(firmsProfitsToGDP) {
				    ...
				    tabSet.add(createScrollPaneFromPlots(profitToGDPplots, "Firms Profit to GDP", profitToGDPplots.size()));
			    }			    
...
//				// eventGroup.addEvent(flag, CommonEventType.Update);
	...
	public boolean isFirmAssets() {
		return firmAssets;
	}

	public void setFirmAssets(boolean firmAssets) {
		this.firmAssets = firmAssets;
	}

	public boolean isFirmsProfits() {
		return firmsProfits;
	}

	public void setFirmsProfits(boolean firmsProfits) {
		this.firmsProfits = firmsProfits;
	}

	public boolean isFirmsProfitsToGDP() {
		return firmsProfitsToGDP;
	}

	public void setFirmsProfitsToGDP(boolean firmsProfitsToGDP) {
		this.firmsProfitsToGDP = firmsProfitsToGDP;
	}

	public boolean iscFirmsInvestment() {
		return cFirmsInvestment;
	}

	public void setcFirmsInvestment(boolean cFirmsInvestment) {
		this.cFirmsInvestment = cFirmsInvestment;
	}

	public boolean iscFirmsInvestmentToGDP() {
		return cFirmsInvestmentToGDP;
	}

	public void setcFirmsInvestmentToGDP(boolean cFirmsInvestmentToGDP) {
		this.cFirmsInvestmentToGDP = cFirmsInvestmentToGDP;
	}

	public boolean iscFirmsCostPriceMarkup() {
		return cFirmsCostPriceMarkup;
	}

	public void setcFirmsCostPriceMarkup(boolean cFirmsCostPriceMarkup) {
		this.cFirmsCostPriceMarkup = cFirmsCostPriceMarkup;
	}

	public boolean iscFirmsCapitalStock() {
		return cFirmsCapitalStock;
	}

	public void setcFirmsCapitalStock(boolean cFirmsCapitalStock) {
		this.cFirmsCapitalStock = cFirmsCapitalStock;
	}

	public boolean iscFirmsDebt() {
		return cFirmsDebt;
	}

	public void setcFirmsDebt(boolean cFirmsDebt) {
		this.cFirmsDebt = cFirmsDebt;
	}

	public boolean iscFirmsCreditRationing() {
		return cFirmsCreditRationing;
	}

	public void setcFirmsCreditRationing(boolean cFirmsCreditRationing) {
		this.cFirmsCreditRationing = cFirmsCreditRationing;
	}

	public boolean isGdpAccountingIdentities() {
		return gdpAccountingIdentities;
	}
